...
# Problema 1
En una fábrica que produce lotes de tinte están preocupados por la consistencia de
la fuerza del tinte. Para medir la fuerza del tinte se pintan cuadrados de tela bajo
condiciones controladas. Estos cuadrados de tela se comparan con un estándar, si hay
coincidencia se califica con 100. Se seleccionaron al azar 6 lotes de tinte, para cada uno
se seleccionaron al azar 6 cuadrados de tela entintada y se calificaron. Los datos son:
...
TukeyHSD(analisis)
```
Por el análisis de Tukey podemos decir que 
